...
def dashboard(request):
    ...
    messages.success(request, 'Usuário gravado com sucesso')
    messages.success(request, f'Usuário {request.POST.get("nome")} {request.POST.get("sobrenome")} gravado com sucesso')
    form.save()
    return redirect('dashboard')
